                ...
                <div class="carousel-item">
                  ...
                  <div class="row">
                    <div class="col-sm-4  w-30-m">
                        <Link to="https://storystorm-khmw9djz6-friend-it-solution.vercel.app/#/art" class="text-center storyCont">
                          <img src="./images/dummy.png" class="rounded img-fluid" />
                          <h5 class="defaultColor mt-4 mb-1">Manga</h5>
                          <p>5 in x 7.5 in</p>
                        </Link>
                    ...
                    <div class="col-sm-4 w-30-m">
                        <a href="https://storystorm-khmw9djz6-friend-it-solution.vercel.app/#/art" class="text-center storyCont">
                          <img src="./images/dummy.png" class="rounded img-fluid" />
                          <h5 class="defaultColor mt-4 mb-1">Webtoon</h5>
                          <p>800 in x 1280 in</p>
                        </a>
